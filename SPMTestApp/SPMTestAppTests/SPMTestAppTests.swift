...
@testable import SPMTestApp

final class SPMTestAppTests: XCTestCase {
  override func setUp() {
    super.setUp()
    // do setup
  }
  ...
  func testLoginWithConfig() {
    ...
    let grabIdPartner = GrabIdPartner(urlSession: mockUrlSession, bundle: Bundle(for: SPMTestAppTests.self))
